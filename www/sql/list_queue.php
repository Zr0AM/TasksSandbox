...
$status = scripts::getPostVar('queueStatus');
$taskID = scripts::getPostVar('task');

$viewItem = scripts::getPostVar('viewQueueItem');
$completeItem = scripts::getPostVar('completeQueueItem');
