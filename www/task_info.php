...
$taskId = sql\scripts::getPostVar('task');

$editForm = sql\scripts::getPostVar('edit');
$saveForm = sql\scripts::getPostVar('save');

$userId = $_SESSION['userid'];
$taskName = sql\scripts::getPostVar('taskName');
$taskDesc = sql\scripts::getPostVar('taskDescription');
$taskStart = sql\scripts::getPostVar('startDate');
$taskEnd = sql\scripts::getPostVar('endDate');
$taskRecur = sql\scripts::getPostVar('recurrOption');

$viewItem = sql\scripts::getPostVar('viewQueueItem');
$completeItem = sql\scripts::getPostVar('completeQueueItem');
...
$objDropdown->setOnChange("getQueueStatusWithTask(this.value," . sql\scripts::getPostVar('task') . ")");
